...
<html lang="pl">
  <head>
    ...
    if ($idp == '' || $idp == 'glowna') $strona = 1;
    elseif ($idp == 'skladniki') $strona = 2;
    elseif ($idp == 'przepisy') $strona = 3;
    elseif ($idp == 'filmy') $strona = 4;
    elseif ($idp == 'kultura') $strona = 5;
    elseif ($idp == 'polecane') $strona = 6;
    elseif ($idp == 'poligon_js') $strona = 7;
